package com.duoduo.common.component.sms.config;

import com.duoduo.common.component.sms.support.MapSceneRepository;
import com.duoduo.common.component.sms.support.SceneRepository;
import com.duoduo.common.component.sms.support.SmsManager;
import com.duoduo.common.component.sms.support.SmsSender;
import com.duoduo.common.component.sms.support.aliyun.AliyunProperties;
import com.duoduo.common.component.sms.support.aliyun.AliyunSender;
import com.duoduo.common.component.sms.support.zhutong.ZhuTongProperties;
import com.duoduo.common.component.sms.support.zhutong.ZhuTongSender;
...
public class SmsConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "duoduo.sms.zt", name = "passwd")
    ...
    @Bean
    @ConditionalOnProperty(prefix = "duoduo.sms.aliyun", name = "accessKeySecret")
    @ConditionalOnMissingBean(SmsSender.class)
